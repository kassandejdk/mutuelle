...
<x-dashbord.dashbord_body >
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
      ...
      <div class="row ">
        ...
        @endif
        <div class="col-lg-12">
          <h4 class="mb-3 mb-md-0">Liste des membres bannits </h4>
        </div>
                ...
                <table id="dataTableExample" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-danger btnPad " data-toggle="modal" data-target="#deleteBannit{{ $membre->id }}">
                    ...
                    <!-- Modal de confirmation de suppresion de membre-->
                    <div class="modal fade" id="deleteBannit{{ $membre->id }}" tabindex="-1" role="dialog" aria-labelledby="voirplusLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <form action="{{ route('delete.user', $membre->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
